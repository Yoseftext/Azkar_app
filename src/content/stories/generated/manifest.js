export const STORY_CATEGORY_MANIFEST = [
  {
    ...
    "featuredTitle": "قصة عن التوبة",
    "featuredLesson": "الرجوع إلى الحق يحتاج شجاعة وصدقاً مع النفس.",
  ...
  },
  {
    ...
    "featuredTitle": "قصة آدم عليه السلام وتعلم الأسماء",
    "featuredLesson": "في قصص الأنبياء عبرة في التوحيد والصبر والثبات وحسن التوكل على الله.",
    "summaryBatchCount": 4,
    "summaryBatchSize": 32
  },
  {
    ...
    "featuredTitle": "قصة أبي بكر الصديق رضي الله عنه والإيمان المبكر",
    "featuredLesson": "في سير الصحابة دروس في الصدق والبذل والعلم والثبات وحسن الاقتداء.",
    "summaryBatchCount": 4,
    "summaryBatchSize": 32
  }
];
export default STORY_CATEGORY_MANIFEST;
